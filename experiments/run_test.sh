...
TYPE=full
python3 test_s2s.py --cuda --features ${TYPE} --p_encoder_arch mpnn --p_decoder_arch mpnn --file_splits ../data/cath/chain_set_splits.json --restore ${CHECKPOINT} > log/test_all_h128_mpnn.log
python3 test_s2s.py --cuda --features ${TYPE} --p_encoder_arch mpnn --p_decoder_arch mpnn --file_splits ../data/SPIN2/test_split_sc.json --restore ${CHECKPOINT} > log/test_sc_h128_mpnn.log
python3 test_s2s.py --cuda --features ${TYPE} --p_encoder_arch mpnn --p_decoder_arch mpnn --file_splits ../data/SPIN2/test_split_L100.json --restore ${CHECKPOINT} > log/test_L100_h128_mpnn.log