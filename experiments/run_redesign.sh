...
ARGS="--cuda --features full --p_encoder_arch mpnn --p_decoder_arch mpnn --restore ${CHECKPOINT} --file_data ../data/cath/chain_set.jsonl --file_splits ../data/SPIN2/test_split_sc.json"
...
ARGS="--cuda --features full --p_encoder_arch mpnn --p_decoder_arch mpnn --restore ${CHECKPOINT} --file_data ../data/ollikainen/ollikainen_set.jsonl --file_splits ../data/ollikainen/ollikainen_benchmark.json"
